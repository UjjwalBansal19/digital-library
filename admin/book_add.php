...
$filetmp = $_FILES["file_img"]["tmp_name"];
 ...
 $query= "INSERT INTO `book`(`book_id`, `category_name`, `book_name`, `book_image`, `book_price`, `book_discription`, `short_disc`, `book_bigimage`, `publisher`, `subcat_name`, `path`) VALUES('".$_POST['txtid']."', '".$_POST['category_name']."', '".$_POST['txtprodnm']."', '".$fileupload."', '".$_POST['txtprice']."', '".$_POST['txtdisc']."', '".$_POST['txtshortdisc']."', '".$fileuploadbig."', '".$_POST['txtpublisher']."', '".$_POST['subcatnm']."','".$filepath."')";
//exit;
$res=mysql_query($query);
header("location:addbook.php?name=addbook");
?>